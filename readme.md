...
характеристик измерителей скорости, имеющих рабочую частоту 24.5-24.25 ГГц.
...
Путь к папке, в которую будет установлен программный продукт. По умолчанию - `%ProgramFiles(x86)%\STP\RashodomerISO\2.4`.
